Write-Host "=== KATHA & SCHOOL APPLICATIONS STARTUP SCRIPT (IMPROVED) ===" -ForegroundColor Green
...
# Final port check with validation
...
if ($allPortsRunning) {
    ...
    Write-Host "`n⚠ Some applications may not have started properly. Check the PowerShell windows for errors." -ForegroundColor Yellow
}
