...
// API endpoints
const API_STOCK_BY_GROUP = 'http://168.231.122.33:4000/api/reports/stock-by-group';
const API_STOCK_BY_CATEGORY = 'http://168.231.122.33:4000/api/reports/stock-by-category';
const API_STOCK_BY_ITEM = 'http://168.231.122.33:4000/api/reports/stock-by-item';
const API_LAST_PURCHASE = 'http://168.231.122.33:4000/api/last-purchase-by-code';
...
const StockReport = () => {
  ...
  const fetchGroupData = async () => {
    setLoading(true);
    try {
      const response = await axios.get(API_STOCK_BY_GROUP);
