...
const otherReports = [
  { name: 'Payable 5th Commission', href: ROUTES.PAYABLE_5TH_COMMISSION },
  { name: 'Paid 5th Commission', href: ROUTES.PAID_5TH_COMMISSION },
  { name: 'Sup-Payable 5th Report', href: ROUTES.SUP_PAYABLE_5TH_COMMISSION },
  { name: 'Sup-Paid 5th Report', href: ROUTES.SUP_PAID_5TH_COMMISSION },
  { name: 'Payable 6th Commission', href: ROUTES.PAYABLE_6TH_COMMISSION },
  { name: 'Paid 6th Commission', href: ROUTES.PAID_6TH_COMMISSION },
  { name: 'Sup-Payable 6th Report', href: ROUTES.SUP_PAYABLE_6TH_COMMISSION },
  { name: 'Sup-Paid 6th Report', href: ROUTES.SUP_PAID_6TH_COMMISSION },
  { name: 'Payable 7th Commission', href: ROUTES.PAYABLE_7TH_COMMISSION },
  { name: 'Paid 7th Commission', href: ROUTES.PAID_7TH_COMMISSION },
  { name: 'Payable HRA Report', href: ROUTES.PAYABLE_HRA },
  { name: 'Paid HRA Report', href: ROUTES.PAID_HRA },
];
...
const TopBar = () => {
  ...
  const handleLogout = () => {
    ...
    // Redirect to main application (using port 5177)
  ...
  return (
    <div className="w-full bg-blue-700 py-2 px-4 flex items-center justify-between shadow-md">
      <div className="flex items-center space-x-4">
        ...
        <button
          onClick={() => navigate(ROUTES.TEACHER_MANAGEMENT)}
          className="flex items-center text-white font-semibold hover:text-yellow-300 focus:outline-none transition-colors"
        >
        ...
        <button
          onClick={() => navigate(ROUTES.SALARY_MANAGEMENT)}
          className="flex items-center text-white font-semibold hover:text-yellow-300 focus:outline-none transition-colors"
        >
        ...
        <button
          onClick={() => navigate(ROUTES.LWP_MANAGEMENT)}
          className="flex items-center text-white font-semibold hover:text-yellow-300 focus:outline-none transition-colors"
        >
        ...
        {/* Test Button */}
        <button
          onClick={() => navigate(ROUTES.TEST_REPORT)}
          className="flex items-center text-white font-semibold hover:text-yellow-300 focus:outline-none transition-colors bg-green-600 px-3 py-1 rounded"
        >
          Test Report
        </button>
      </div>
